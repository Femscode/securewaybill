            ...
            <tbody>
                <tr>
                    <td style="text-align:center; padding: 40px">
                        <a href="https://vtubiz.com/all_withdrawals" rel="noopener" target="_blank">Withdraw Request
                <tr>
                        ...
                        <div
                            ...
                            <div style="padding-bottom: 30px"><p>
                                ...
                                <ul>
                                    ...
                                    <li>Product Name : {{ $waybill->product_amount }}</li>
                                    <li>Amount : NGN{{ number_format($waybill->amount) }}</li>
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                <a href="https://securewaybill.com/{{ $ref }}" rel="noopener"
                            ...
                            <div style="padding-bottom: 40px; text-align:center;">
                                ...
                                <a href="https://wa.me/2349058744473?text=Hi,%20I%20am%20here%20to%20report%20a%20transaction%20on%20SECUREWAYBILL..." rel="noopener"
                                    target="_blank" rel="noopener"
                                    style="text-decoration:none;display:inline-block;text-align:center;padding:0.75575rem 1.3rem;font-size:0.925rem;line-height:1.5;border-radius:0.35rem;color:#ffffff;background-color:#009EF7;border:0px;margin-right:0.75rem!important;font-weight:600!important;outline:none!important;vertical-align:middle"
