...
<head>
  ...
  <title>SECUREWAYBILL | SUPERDASHBOARD</title>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <div id="navbarVerticalMenuPagesMenu">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/allwaybills">
            <i class="bi bi-menu-button-wide"></i><span>All Waybills</span>
          </a>
       
        </li>

        <li class="nav-item">
            <a class="nav-link collapsed" href="/allusers" role="button">
              <i class="bi-person-badge"></i>
              <span class="nav-link-title" @if($active == 'profile') style='color:#377dff'@endif>User Management</span>
            </a>
