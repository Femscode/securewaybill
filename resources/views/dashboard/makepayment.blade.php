                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center bg-soft-primary rounded p-5">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 mr-2">
                                        <span class="text-info font-weight-bold">Client Name</span>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-lg-9 col-xl-6">
                            <div style='text-align:left;border:2px dotted blue'
                                ...
                                <input name='amount' type='hidden' id='totalamounthidden'  value="{{ $waybill->totalamount }}" /><br><br>
                                <input name='waybillId' type='hidden' id='totalamounthidden'  value="{{ $waybill->uid }}" /><br><br>
                                Mode Of Payment : 
