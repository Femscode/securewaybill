...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('newdashboard/css/vendor.min.css')}}">

  <!-- CSS Front Template -->
  <link rel="stylesheet" href="{{ asset('newdashboard/css/theme.minc619.css?v=1.0')}}">

  <link rel="preload" href="{{ asset('newdashboard/css/theme.min.css')}}" data-hs-appearance="default" as="style">
  <link rel="preload" href="{{ asset('newdashboard/css/theme-dark.min.css')}}" data-hs-appearance="dark" as="style">
  <link rel="stylesheet" type="text/css" href="{{ asset('cdn/dataTables.min.css') }}">
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
  ...
  <script src="{{ asset('newdashboard/js/hs.theme-appearance.js')}}"></script>

  <script src="{{ asset('newdashboard/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js')}}">
  </script>
  ...
  <header id="header"
    ...
    <div class="navbar-nav-wrap">
      ...
      <a class="navbar-brand" href="index.html" aria-label="Front">
        <img class="navbar-brand-logo" src="{{ asset('newdashboard/svg/logos/logo.svg')}}" alt="Logo"
          data-hs-theme-appearance="default">
        <img class="navbar-brand-logo" src="{{ asset('newdashboard/svg/logos-light/logo.svg')}}" alt="Logo"
          data-hs-theme-appearance="dark">
        <img class="navbar-brand-logo-mini" src="{{ asset('newdashboard/svg/logos/logo-short.svg')}}" alt="Logo"
          data-hs-theme-appearance="default">
        <img class="navbar-brand-logo-mini" src="{{ asset('newdashboard/svg/logos-light/logo-short.svg')}}" alt="Logo"
          data-hs-theme-appearance="dark">
      </a>
      <!-- End Logo -->
        ...
        <div class="dropdown ms-2">
          ...
          <div class="d-none d-lg-block">
            <div
              ...
              <input type="search" class="js-form-search form-control" placeholder="Search for waybill..."
                aria-label="Search for waybill..." data-hs-form-search-options='{
              ...
              <div class="card-body-height">
                <div class="d-lg-none">
                  <div class="input-group input-group-merge navbar-input-group mb-5">
                    ...
                    <input type="search" class="form-control" placeholder="Search for waybill..."
                      aria-label="Search for waybill...">
                    <a class="input-group-append input-group-text" href="javascript:;">
                      <i class="bi-x-lg"></i>
                    </a>
                  </div>
                ...
                <a class="dropdown-item" href="index.html">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="avatar avatar-xs avatar-circle" src="{{ asset('newdashboard/img/160x160/img10.jpg')}}"
                ...
                <a class="dropdown-item" href="index.html">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="avatar avatar-xs avatar-circle" src="{{ asset('newdashboard/img/160x160/img3.jpg')}}"
                        alt="Image Description">
                    </div>
                    <div class="flex-grow-1 text-truncate ms-2">
                              ...
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <img class="avatar avatar-sm avatar-circle"
                                    src="{{ asset('newdashboard/img/160x160/img3.jpg')}}" alt="Image Description">
                                </div>
                              </div>
                              <!-- End Col -->
                              ...
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('newdashboard/img/160x160/img10.jpg')}}"
                                      alt="Image Description">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('newdashboard/svg/brands/google-icon.svg')}}"
                                      alt="Image Description">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('newdashboard/img/160x160/img7.jpg')}}"
                                      alt="Image Description">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('newdashboard/img/160x160/img5.jpg')}}"
                                      alt="Image Description">
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="row">
                              <div class="col-auto">
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="avatar avatar-sm avatar-circle">
                                    <img class="avatar-img" src="{{ asset('newdashboard/img/160x160/img8.jpg')}}"
                                      alt="Image Description">
                                  </div>
                                </div>
                              </div>
          ...
          <li class="nav-item">
            ...
            <div class="dropdown">
              <a class="navbar-dropdown-account-wrapper" href="javascript:;" id="accountNavbarDropdown"
                ...
                <div class="avatar avatar-sm avatar-circle">
                  @if($user->logo !== null)
                  <img class="avatar-img" src="{{ asset('brand_images/'.$user->logo.'')}}"
                  alt="Image Description">
                  @else 
                  <img class="avatar-img" src="{{ asset('newdashboard/img/160x160/img6.jpg')}}"
                  alt="Image Description">
                  @endif
              ...
              <div
                ...
                <div class="dropdown">
                  <a class="navbar-dropdown-submenu-item dropdown-item dropdown-toggle" href="javascript:;"
                    id="navSubmenuPagesAccountDropdown1" data-bs-toggle="dropdown" aria-expanded="false">My Waybills</a>
                  ...
                  <div
                    ...
                    <a class="dropdown-item" href="#">
                      <span class="legend-indicator bg-success me-1"></span> Completed
                    </a>
                    <a class="dropdown-item" href="#">
                      <span class="legend-indicator bg-danger me-1"></span> Pending
                    </a>
                    <a class="dropdown-item" href="#">
                      <span class="legend-indicator bg-warning me-1"></span> Cancelled
                    </a>
                ...
                <a class="dropdown-item" href="#">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <div class="avatar avatar-sm avatar-dark avatar-circle">
                        <span class="avatar-initials">SWB</span>
                      </div>
                    </div>
                    <div class="flex-grow-1 ms-2">
                      <h5 class="mb-0">SecureWayBill <span
                          class="badge bg-primary rounded-pill text-uppercase ms-1">PRO</span></h5>
                      <span class="card-text">Free Trial For Pro Version</span>
                    </div>
                  </div>
                </a>
                ...
                <a href='/logout' onclick='return confirm("Are you sure you want to sign out?")' class="dropdown-item"
      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            <!-- Collapse -->
            <div class="nav-item">
              <a class="nav-link dropdown-toggle @if($active == 'dashboard') active @endif" href="#navbarVerticalMenuDashboards" role="button"
                data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" @if($active == 'dashboard') aria-expanded="true" @endif
                aria-controls="navbarVerticalMenuDashboards">
                <i class="bi-house-door nav-icon"></i>
                <span class="nav-link-title">Dashboard</span>
              </a>

              <div id="navbarVerticalMenuDashboards" class="nav-collapse  @if($active == 'dashboard') collapse show @endif"
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link dropdown-toggle @if($active == 'waybill') active @endif" href="#navbarVerticalMenuPagesEcommerceMenu" role="button"
                  data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesEcommerceMenu" aria-expanded="false"
                  aria-controls="navbarVerticalMenuPagesEcommerceMenu">
                  <i class="bi-basket nav-icon"></i>
                  <span class="nav-link-title">Waybill</span>
                </a>

                <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse "
                  data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link " href="/createwaybill">Create Waybill</a>

                  <a class="nav-link " href="/my-waybills">View Waybills</a>
                </div>
              </div>
              <!-- End Collapse -->
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link dropdown-toggle  collapsed @if($active == 'password')active @endif" href="#" role="button" data-bs-toggle="collapse"
                  ...
                  <span class="nav-link-title">Password</span>
                </a>
                ...
                <div id="navbarVerticalMenuAuthentication" class="nav-collapse collapse "
                  ...
                  <div id="navbarVerticalMenuAuthenticationMenu">
                    ...
                    <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#welcomeMessageModal">This is a
                      welcome message modal</a>
                    <a class="nav-link " href="/change_password">Reset Password</a>
                  </div>
                </div>
              </div>
              <div class="nav-item">
                <a class="nav-link dropdown-toggle  collapsed" href="#" role="button" data-bs-toggle="collapse"
                  data-bs-target="#navbarVerticalMenuAuthentication2" aria-expanded="false"
                  aria-controls="navbarVerticalMenuAuthentication2">
                  <i class="bi-key nav-icon"></i>
                  <span class="nav-link-title">Withdrawal Pin</span>
                </a>
                ...
                <div id="navbarVerticalMenuAuthentication2" class="nav-collapse collapse "
                  ...
                  <div id="navbarVerticalMenuAuthenticationMenu">
                    ...
                    <a class="nav-link" href="/change-pin">Change Pin</a>
                    <a class="nav-link " href="/change-pin">Reset Pin</a>
                  </div>
                </div>
              </div>

              <div class="nav-item">
                <a class="nav-link dropdown-toggle collapsed" href="#navbarVerticalMenuPagesProjectsMenu" role="button"
                  ...
                  <span class="nav-link-title">Transactions & Activities</span>
                </a>

                <div id="navbarVerticalMenuPagesProjectsMenu" class="nav-collapse collapse"
                  data-bs-parent="#navbarVerticalMenuPagesMenu" hs-parent-area="#navbarVerticalMenu" style="top: 0px;">
                ...
                <div class="dropdown dropup">
                  <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle"
                    ...
                    <img class="avatar avatar-xss avatar-circle"
                      src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/us.svg')}}" alt="United States Flag">
                  </button>
                  ...
                  <div class="dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="selectLanguageDropdown">
                    ...
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/us.svg')}}" alt="Flag">
                      <span class="text-truncate" title="English">English (US)</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/gb.svg')}}" alt="Flag">
                      <span class="text-truncate" title="English">English (UK)</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/de.svg')}}" alt="Flag">
                      <span class="text-truncate" title="Deutsch">Deutsch</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/dk.svg')}}" alt="Flag">
                      <span class="text-truncate" title="Dansk">Dansk</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/it.svg')}}" alt="Flag">
                      <span class="text-truncate" title="Italiano">Italiano</span>
                    </a>
                    <a class="dropdown-item" href="#">
                      <img class="avatar avatar-xss avatar-circle me-2"
                        src="{{ asset('newdashboard/vendor/flag-icon-css/flags/1x1/cn.svg')}}" alt="Flag">
  ...
  <main id="content" role="main" class="main">
      ...
      <div class="content container-fluid" style="height: 25rem;">
        ...
        <div class="page-header page-header-light">
          <div class="row align-items-center">
            <div class="col">
              <h1 class="page-header-title">Welcome, {{ $user->name }}</h1>
            </div>
            <!-- End Col -->
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0">&copy; SECUREWAYBILL, <span class="d-none d-sm-inline-block">
              <?php echo Date('Y');?>. A product of <a href='https://cthostel.com'>CTHOSTEL</a>.
            </span></p>
        </div>
        <!-- End Col -->
        ...
        <div class="col-auto">
          <div class="d-flex justify-content-end">
            ...
            <ul class="list-inline list-separator">
              ...
              <li class="list-inline-item">
                <a class="list-separator-link" href="#">Legal Terms</a>
              </li>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBuilder" aria-labelledby="offcanvasBuilderLabel">
    ...
    <div class="offcanvas-body">
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            <input type="radio" class="form-check-input" name="layoutSkinsRadio" id="layoutSkinsRadio1" checked
              value="default">
            <label class="form-check-label mb-2" for="layoutSkinsRadio1">
              <img class="form-check-img" src="{{ asset('newdashboard/img/415x310/img1.jpg')}}" alt="Image Description">
            </label>
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="layoutSkinsRadio2">
              <img class="form-check-img" src="{{ asset('newdashboard/img/415x310/img2.jpg')}}" alt="Image Description">
            </label>
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio1">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts-light/sidebar-default.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/sidebar-default.svg')}}"
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="navbarLayoutSkinsRadio2">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts-light/sidebar-dark.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/sidebar-dark.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
            </label>
      ...
      <div class="row gx-3">
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            <input type="radio" class="form-check-input" name="sidebarNavOptions" id="sidebarNavOptions1" value="pills"
              checked>
            <label class="form-check-label mb-2" for="sidebarNavOptions1">
              <img class="form-check-img"
                src="{{ asset('newdashboard/svg/layouts-light/demo-layouts-default-classic.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/demo-layouts-default-classic.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
            </label>
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="sidebarNavOptions2">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts-light/demo-layouts-nav-tabs.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/demo-layouts-nav-tabs.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
            </label>
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="headerLayoutOptions1">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/header-default-container.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
              <img class="form-check-img"
                src="{{ asset('newdashboard/svg/layouts-light/header-default-container.svg')}}" alt="Image Description"
                data-hs-theme-appearance="dark">
            </label>
            <span class="form-check-text">Default</span>
          </div>
        ...
        <div class="col-6">
          <div class="form-check form-check-label-highlighter text-center">
            ...
            <label class="form-check-label mb-2" for="headerLayoutOptions2">
              <img class="form-check-img" src="{{ asset('newdashboard/svg/layouts/header-double-line-container.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
              <img class="form-check-img"
                src="{{ asset('newdashboard/svg/layouts-light/header-double-line-container.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
            </label>
  ...
  <div id="builderOffcanvas" class="position-fixed bottom-0 end-0 me-5 mb-5" style="z-index: 3;"
    ...
    <a class="btn btn-dark btn-lg" href="javascript:;">
      <i class="bi-sliders fs-6 me-2"></i> Message Us
    </a>
  </div>
  <!-- End Builder Toggle -->
                              ...
                              <ul class="list-group list-group-flush navbar-card-list-group">
                                ...
                                <li class="list-group-item form-check-select">
                                  <div class="row">
                                      ...
                                      <div class="d-flex align-items-center">
                                        ...
                                        <div class="avatar avatar-sm avatar-circle">
                                          <img class="avatar-img"
                                            src="{{ asset('newdashboard/svg/brands/google-icon.svg')}}"
                                            alt="Image Description">
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col ms-n2">
                                      <h5 class="mb-1">from Google</h5>
                                      <p class="text-body fs-5">Start using forms to capture the information of
                        ...
                        <div class="card-body card-body-height">
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3"
                                  src="{{ asset('newdashboard/svg/brands/atlassian-icon.svg')}}"
                                  alt="Image Description">
                              </div>
                          ...
                          <a class="dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3"
                                  src="{{ asset('newdashboard/svg/brands/slack-icon.svg')}}" alt="Image Description">
                              </div>
                              <div class="flex-grow-1 text-truncate ms-3">
                          ...
                          <a class="dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3"
                                  src="{{ asset('newdashboard/svg/brands/google-webdev-icon.svg')}}"
                                  alt="Image Description">
                              </div>
                              <div class="flex-grow-1 text-truncate ms-3">
                          ...
                          <a class="dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3"
                                  src="{{ asset('newdashboard/svg/brands/frontapp-icon.svg')}}" alt="Image Description">
                              </div>
                              <div class="flex-grow-1 text-truncate ms-3">
                          ...
                          <a class="dropdown-item" href="#">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-4x3"
                                  src="{{ asset('newdashboard/svg/illustrations/review-rating-shield.svg')}}"
                                  alt="Image Description">
                              </div>
                              <div class="flex-grow-1 text-truncate ms-3">
            ...
            <div class="collapse navbar-collapse" id="navbarContainerNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="hs-has-sub-menu nav-item">
                  <a id="dashboardsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="#"
                    role="button"><i class="bi-house-door dropdown-item-icon"></i> Dashboards</a>
                ...
                <!-- Pages -->
                <li class="hs-has-sub-menu nav-item">
                  <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " href="#" role="button"><i
                      class="bi-files-alt dropdown-item-icon"></i> Pages</a>

                  <!-- Mega Menu -->
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu"
                    style="min-width: 14rem;">
                    <!-- Users -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="usersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        role="button">Users</a>
                    ...
                    <!-- User Profile -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="userProfileMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        role="button">User Profile <span class="badge bg-primary rounded-pill ms-1">5</span></a>
                    ...
                    <!-- Account -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="accountMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                    ...
                    <!-- E-commerce -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="ecommerceMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        role="button">E-commerce</a>
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                        ...
                        <!-- Products -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="productsMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        ...
                        <!-- Products -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="ordersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        ...
                        <!-- Customers -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="customersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                            role="button">Customers</a>
                    ...
                    <!-- Projects -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="projectsMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                    ...
                    <!-- Project -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="projectMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                    ...
                    <!-- Authentication -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="authenticationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle "
                      ...
                      <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                        ...
                        <!-- Log In -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="loginMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        ...
                        <!-- Sign Up -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="signupMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
                        ...
                        <!-- Reset Password -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="resetPasswordMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle "
                            href="#" role="button">Reset Password</a>

                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                            aria-labelledby="resetPasswordMegaMenu" style="min-width: 14rem;">
                        ...
                        <!-- Email Verification -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="emailVerificationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle "
                            href="#" role="button">Email Verification</a>

                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                            aria-labelledby="emailVerificationMegaMenu" style="min-width: 14rem;">
                        ...
                        <!-- 2-step Verification -->
                        <div class="hs-has-sub-menu nav-item">
                          <a id="2stepVerificationMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle "
                            href="#" role="button">2-step Verification</a>

                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                            aria-labelledby="2stepVerificationMegaMenu" style="min-width: 14rem;">
                    ...
                    <a class="dropdown-item " href="landing.html" data-placement="left">Landing Page <span
        ...
        <div class="navbar-dark w-100 bg-dark py-2">
          <div class="container">
            <div class="navbar-nav-wrap">
              <!-- Logo -->
              <a class="navbar-brand" href="index.html" aria-label="Front">
                <img class="navbar-brand-logo" src="{{ asset('newdashboard/svg/logos/logo-white.svg')}}" alt="Logo">
              </a>
              <!-- End Logo -->
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0">
                                <img class="avatar avatar-xs avatar-circle"
                                  src="{{ asset('newdashboard/img/160x160/img10.jpg')}}" alt="Image Description">
                              </div>
                              <div class="flex-grow-1 text-truncate ms-2">
                                <span>Amanda Harvey <i class="tio-verified text-primary" data-toggle="tooltip"
                                    data-placement="top" title="Top endorsed"></i></span>
              ...
              <div class="navbar-nav-wrap-content-end">
                ...
                <ul class="navbar-nav">
                                    ...
                                    <div class="row">
                                      <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <img class="avatar avatar-sm avatar-circle"
                                            src="{{ asset('newdashboard/img/160x160/img3.jpg')}}"
                                            alt="Image Description">
                                        </div>
                                      </div>
                                      <!-- End Col -->
                                    ...
                                    <div class="row">
                                      <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="avatar avatar-sm avatar-circle">
                                            <img class="avatar-img"
                                              src="{{ asset('newdashboard/img/160x160/img10.jpg')}}"
                                              alt="Image Description">
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="avatar avatar-sm avatar-circle">
                                            <img class="avatar-img"
                                              src="{{ asset('newdashboard/img/160x160/img7.jpg')}}"
                                              alt="Image Description">
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="avatar avatar-sm avatar-circle">
                                            <img class="avatar-img"
                                              src="{{ asset('newdashboard/img/160x160/img5.jpg')}}"
                                              alt="Image Description">
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="row">
                                      <div class="col-auto">
                                        <div class="d-flex align-items-center">
                                          ...
                                          <div class="avatar avatar-sm avatar-circle">
                                            <img class="avatar-img"
                                              src="{{ asset('newdashboard/img/160x160/img8.jpg')}}"
                                              alt="Image Description">
                                          </div>
                                        </div>
                                      </div>
                  ...
                  <li class="nav-item d-none d-sm-inline-block">
                    <!-- Activity -->
                    <button class="btn btn-ghost-light btn-icon rounded-circle" type="button" data-bs-toggle="offcanvas"
                      data-bs-target="#offcanvasActivityStream" aria-controls="offcanvasActivityStream">
                      <i class="bi-x-diamond"></i>
                    </button>
                    <!-- Activity -->
                  ...
                  <li class="nav-item">
                    <!-- Style Switcher -->
                    <div class="dropdown ">
                      <button type="button" class="btn btn-ghost-light btn-icon rounded-circle" id="selectThemeDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
  ...
  <script src="{{ asset('newdashboard/js/demo.js')}}"></script>
    ...
    <div class="offcanvas-body">
      ...
      <ul class="step step-icon-sm step-avatar-sm">
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            <div class="step-avatar">
              <img class="step-avatar" src="{{ asset('newdashboard/img/160x160/img9.jpg')}}" alt="Image Description">
            </div>
                ...
                <li class="list-group-item list-group-item-light">
                  <div class="row gx-1">
                    <div class="col-6">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs" src="{{ asset('newdashboard/svg/brands/excel-icon.svg')}}"
                            alt="Image Description">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-2">
                    ...
                    <div class="col-6">
                      ...
                      <div class="d-flex">
                        <div class="flex-shrink-0">
                          <img class="avatar avatar-xs" src="{{ asset('newdashboard/svg/brands/word-icon.svg')}}"
                            alt="Image Description">
                        </div>
                        <div class="flex-grow-1 text-truncate ms-2">
                          <span class="d-block fs-6 text-dark text-truncate"
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            <div class="step-avatar">
              <img class="step-avatar-img" src="{{ asset('newdashboard/img/160x160/img3.jpg')}}"
                alt="Image Description">
            </div>
            ...
            <div class="step-content">
              ...
              <ul class="list-group list-group-sm">
                <li class="list-group-item list-group-item-light">
                  <div class="row gx-1">
                    <div class="col">
                      <img class="img-fluid rounded" src="{{ asset('newdashboard/svg/components/card-1.svg')}}"
                        alt="Image Description">
                    </div>
                    <div class="col">
                      <img class="img-fluid rounded" src="{{ asset('newdashboard/svg/components/card-2.svg')}}"
                        alt="Image Description">
                    </div>
                    <div class="col">
                      <img class="img-fluid rounded" src="{{ asset('newdashboard/svg/components/card-3.svg')}}"
                        alt="Image Description">
                    </div>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            <div class="step-avatar">
              <img class="step-avatar-img" src="{{ asset('newdashboard/img/160x160/img7.jpg')}}"
                alt="Image Description">
            </div>
        ...
        <li class="step-item">
          <div class="step-content-wrapper">
            <div class="step-avatar">
              <img class="step-avatar-img" src="{{ asset('newdashboard/img/160x160/img5.jpg')}}"
                alt="Image Description">
            </div>
        ...
        <div class="modal-body p-sm-5">
          <div class="text-center">
            <div class="w-75 w-sm-50 mx-auto mb-4">
              <img class="img-fluid" src="{{ asset('newdashboard/svg/illustrations/oc-collaboration.svg')}}"
                alt="Image Description" data-hs-theme-appearance="default">
              <img class="img-fluid" src="{{ asset('newdashboard/svg/illustrations-light/oc-collaboration.svg')}}"
                alt="Image Description" data-hs-theme-appearance="dark">
            </div>
        ...
        <div class="modal-footer d-block text-center py-sm-5">
          ...
          <div class="w-85 mx-auto">
            <div class="row justify-content-between">
              <div class="col">
                <img class="img-fluid" src="{{ asset('newdashboard/svg/brands/gitlab-gray.svg')}}"
                  alt="Image Description">
              </div>
              <div class="col">
                <img class="img-fluid" src="{{ asset('newdashboard/svg/brands/fitbit-gray.svg')}}"
                  alt="Image Description">
              </div>
              <div class="col">
                <img class="img-fluid" src="{{ asset('newdashboard/svg/brands/flow-xo-gray.svg')}}"
                  alt="Image Description">
              </div>
              <div class="col">
                <img class="img-fluid" src="{{ asset('newdashboard/svg/brands/layar-gray.svg')}}"
                  alt="Image Description">
              </div>
            </div>
          </div>
  ...
  <script src="{{ asset('newdashboard/js/vendor.min.js')}}"></script>

  <!-- JS Front -->
  <script src="{{ asset('newdashboard/js/theme.min.js')}}"></script>
  <script src="{{ asset('newdashboard/js/hs.theme-appearance-charts.js')}}"></script>
  ...
  <script src="/newdashboard/node_modules/datatables/media/js/jquery.dataTables.min.js"></script>
  <script src="/newdashboard/js/hs.datatables.js"></script>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-alternative.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Feb 2024 15:12:57 GMT -->
